...
BOARD_BOOTIMAGE_PARTITION_SIZE := 134217728        # verified
BOARD_CACHEIMAGE_PARTITION_SIZE := 402653184       # verified
BOARD_DTBOIMG_PARTITION_SIZE := 33554432           # verified
BOARD_RECOVERYIMAGE_PARTITION_SIZE := 134217728    # verified
BOARD_SUPER_PARTITION_SIZE := 9126805504           # verified
BOARD_SYSTEMIMAGE_PARTITION_SIZE := 2147483648     # verified
BOARD_USERDATAIMAGE_PARTITION_SIZE := 114898743296 # verified

BOARD_SUPER_PARTITION_GROUPS := qti_dynamic_partitions
BOARD_QTI_DYNAMIC_PARTITIONS_PARTITION_LIST := system product
BOARD_QTI_DYNAMIC_PARTITIONS_SIZE := 6442450944    # verified, needs to be less that SUPER size and enough to provide ample space for the listed partitions

# Do not change the super partition tables
TARGET_USES_PREBUILT_DYNAMIC_PARTITIONS := true 

BOARD_SYSTEMIMAGE_EXTFS_INODE_COUNT := 16384       # verified
